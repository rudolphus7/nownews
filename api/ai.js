...
"Загинув захисник з Прикарпаття: місто прощається з героєм"
...
4. Останній рядок точно такий: <p><strong>Матеріал підготовлено командою "Прикарпаття NEWS"</strong></p>
...
${cleanText}`;
    ...
    try {
        ...
        const signature = `<p><br></p><hr><p><strong>Матеріал підготовлено командою "Прикарпаття NEWS"</strong></p>`;
