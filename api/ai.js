...
4. Call-to-action: Жодних довгих закликів. Просто напишіть "Деталі:", "Читати повністю:" або "Більше про це:" перед посиланням.
...
ВАЖЛИВО: Поверни тільки готовий текст поста (1-2 речення + заклик + посилання + хештеги). Нічого зайвого! Обов'язково завершуй думку, не обривай текст на півслові.`;
