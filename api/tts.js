    ...
    try {
        ...
        const response = await fetch(url, {
            ...
            body: JSON.stringify({
                contents: [{
                    parts: [{
                        text: `Прочитай цей текст як новинний диктор українського телебачення. Голос має бути чітким, впевненим, нейтральним та авторитетним. Темп рівний, паузи між реченнями природні. Текст: ${text}`
                    }]
                }],
                generationConfig: {
