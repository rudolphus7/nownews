                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <div class="flex items-center gap-3">
                            <a href="\${social.social_facebook || '#'}" class="w-10 h-10 bg-white/5 hover:bg-orange-600 border border-white/10 rounded-xl flex items-center justify-center transition-all duration-300 group" aria-label="Facebook">
                            ...
                            <a href="\${social.social_instagram || '#'}" class="w-10 h-10 bg-white/5 hover:bg-orange-600 border border-white/10 rounded-xl flex items-center justify-center transition-all duration-300 group" aria-label="Instagram">
                            ...
                            <a href="\${social.social_youtube || '#'}" class="w-10 h-10 bg-white/5 hover:bg-red-600 border border-white/10 rounded-xl flex items-center justify-center transition-all duration-300 group" aria-label="YouTube">
